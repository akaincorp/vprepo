    ...
    <section class="content">
            ...
            <div class="card card-primary card-outline card-outline-tabs p-3">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a href="campaign.php" class="nav-link active" aria-selected="true">Campaign</a>
                  </li>
                </ul>
              </div>
              ...
              <table class="table table-bordered table-hover mt-3" id="tb1">
                <thead>
                    <tr>
                       <th>Network Name</th>
                       <th>Affid</th>
                ...
                <tbody>
                <?php  
                    $selectnetwork = "SELECT * FROM tb_network";
                    $resultnetwork = mysqli_query($con, $selectnetwork);

                    while($d = mysqli_fetch_assoc($resultnetwork)) {
                  ?>
                    <tr>
                      <td> <img src="img/<?php echo $d['network_name']?>.png" width = "30"> <b style="margin-left:10px;"><?php echo $d['network_name']?></b></td>
                      <td style="cursor:pointer;"><u data-toggle="modal" data-target="#modal-lg" onclick="setJudul('<?php echo $d['network_name']?>')"><?php echo $d['affid']?></u></td>
                    </tr>
                    <?php  } ?>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <table class="table table-bordered table-hover mt-3" id="tb1">
                ...
                <?php  
                  ...
                  ?>
                    <tr>
                      <td><?php echo $e['id']?></td>
                      <td onclick="setJudulOutstanding('<?php echo $e['affid']?>')"  style="cursor:pointer;"><u data-toggle="modal" data-target="#modal-xl" onclick="openModal('<?php echo $e['affid']?>')"><?php echo $e['affid']?></u></td>
                    </tr>
                    <?php  } ?>
                </tbody>
            </table>
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" id="closeglobalaffid" data-dismiss="modal">Close</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
      ...
      <div class="modal fade" id="modal-xl">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id = "juduloutstanding"></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div class="modal fade" id="modal-lg2">
        <div class="modal-dialog modal-lg">
          <div class="modal-content" style="z-index:999;">
            ...
            <div class="modal-body" id="modalcontentoutstanding">
...
<script>
  ...
  function setJudulOutstanding(judul) {
    document.getElementById('juduloutstanding').innerHTML = judul;
  }


// Function to open the modal with content
function openModalOutstanding(idCustomer) {
    var order_id = idCustomer;

    $.ajax({
        url: '../leader/historyagent.php?order_id=' + order_id,
        type: 'GET',
        success: function(response) {
            $("#modalcontentoutstanding").html(response);
        },
        error: function() {
  ...
  function openModal(affid) {

    $.ajax({
        url: 'affidinfo.php?affid=' + affid,
        type: 'GET',
        success: function(response) {
