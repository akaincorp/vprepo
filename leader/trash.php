...
?>       
      ...
      <!-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> -->
          ...
          <li class="nav-item">
            <a href="trash.php" class="nav-link active">Trash</a>
          </li> -->
          ...
          <div class="card card-primary card-outline card-outline-tabs p-3">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="trash.php" aria-selected="true">Trash</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
...
$selectqueue = "SELECT * FROM tb_trash
                JOIN tb_procces ON tb_trash.id_statusf = tb_procces.id_statusf
                JOIN tb_callback ON tb_trash.id_status = tb_callback.id_status
                JOIN tb_notconnect ON tb_trash.id_statusc = tb_notconnect.id_statusc
                JOIN tb_disclaimer ON tb_trash.id_statusb = tb_disclaimer.id_statusb
                JOIN tb_spam ON tb_trash.id_statusd = tb_spam.id_statusd
                JOIN tb_agent ON tb_trash.id_agent = tb_agent.id_agent";

if (!empty($idFilter)) {
    if (is_numeric($idFilter)) {
        $selectqueue .= " WHERE tb_trash.order_id = '$idFilter'";
    } else {
        $selectqueue .= " WHERE tb_agent.username = '$idFilter'";
    }
}

$selectqueue .= " ORDER BY date_comment DESC"; // Add ORDER BY clause at the end
...
<div class="card mt-3">
              <div class="card-header">
                <h3 class="card-title">Trash Page</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <button type="button" onclick="toHandling()"  class="btn btn-secondary">To handling</button>
 ...
 ?>
            <tr>
                ...
                <td style="
    width: 146px;
"> <b data-toggle='modal' data-target='#modal-xl' style="cursor:pointer;" onclick="openModal(<?php echo $d['order_id']; ?>)"><?php echo $d['order_id']; ?></b><br><?php echo $d['order_date']; ?></td>

                <td style="
    width: 154px;
"><?php echo $d['username']; ?><br>
                    <?php echo $d['date_comment']; ?>
                </td>

                <td><?php echo $d['first_name']; ?>&nbsp;
                    <?php echo $d['last_name'];?>
                </td>

                <td><?php echo $d['phone']; ?></td>

                <td><?php echo $d['status']; ?><?php echo $d['statusb']; ?>
                    <?php echo $d['statusc']; ?><?php echo $d['statusd']; ?>
                </td>
                ...
                <td><?php echo $d['delivery_comment']; ?></td>
