...
?>       
      ...
      <!-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> -->
          ...
          <li class="nav-item">
            <a href="handling.php" class="nav-link active">Handling</a>
          </li>
          <li class="nav-item">
          ...
          <div class="card card-primary card-outline card-outline-tabs p-3">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="handling.php" aria-selected="true">Handling</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-header">
                <h3 class="card-title">Handling Page</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
