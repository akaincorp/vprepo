...
?>       
      ...
      <!-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> -->
          ...
          <li class="nav-item">
            <a href="delivery.php" class="nav-link active">Delivery</a>
          </li>
          <li class="nav-item">
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-primary card-outline card-outline-tabs p-3">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="delivery.php" aria-selected="true">Delivery</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-header">
                <h3 class="card-title">Delivery Page</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-default">
                ...
                <button type="submit" onclick="toHandling()"  class="btn btn-secondary">To handling</button>
</div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">To Rebills Modal</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
            <label for="rebillsSelect">Chose Status :</label>
                        <select name="rebillsSelect" class="form-control" id="rebillselect">
                            <option value=""></option>
                            <option value="DELIVERY_OK">DELIVERY_OK</option>
                            <option value="DELIVERY_NOT_OK">DELIVERY_NOT_OK</option>
                           <option value="CANCEL">CANCEL</option>
                        </select>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <button type="button" onclick="toRebills()"  class="btn btn-primary">Add</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
 ...
 $selectqueue = "SELECT * FROM tb_delivery
                 ...
                 JOIN tb_agent ON tb_delivery.id_agent = tb_agent.id_agent WHERE tb_procces.statusf = 'OUTSTANDING' ORDER BY date_comment DESC";
 if (!empty($idFilter)) {
...
<script>
    function toRebills() {
    const selectedRebills = document.getElementById('rebillselect').value;
    const checkboxes = document.querySelectorAll('#checkboxtabel:checked');

        const formData = new FormData();
        formData.append('rebillsSelect', selectedRebills);

        checkboxes.forEach(checkbox => {
            formData.append('hapus[]', checkbox.value);
        });

        fetch('deliveryrebills.php', {
            method: 'POST',
            body: formData
        })
        .then(response => {
