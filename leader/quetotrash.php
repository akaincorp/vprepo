...
if (isset($_POST['hapus'])) {
    ...
    $selectcustomer = "SELECT * FROM tb_queue WHERE id_customer = '$customerId'";
    ...
    if ($resultcustomer) {
     ...
     $delete = "DELETE FROM tb_queue WHERE id_customer = '$customerId'";
