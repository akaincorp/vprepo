...
?>       
      ...
      <!-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> -->
          ...
          <li class="nav-item">
            <a href="quesort.php" class="nav-link active">Queue Sort Order</a>
          </li>
          <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-primary card-outline card-outline-tabs p-3">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="quesort.php"  aria-selected="true">Queue Sort Order</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-header">
                <h3 class="card-title">Queue Sort Order Page</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">

              <div class="card-body table-responsive p-3" id="cardBody" >
      ...
      <button type="button" onclick="toTrash()" class="btn btn-secondary">To Trash</button>
      </div>
</div>
...
<script src="JS/quesort.js"></script>
...
function openModal(idCustomer) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            modal.style.display = "block"; // Show the modal when content is loaded
        },
        error: function() {
